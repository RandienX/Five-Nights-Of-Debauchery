...
func _load_settings_to_ui() -> void:
	...
	var settings = Engine.get_singleton("Settings")
...
func _on_master_volume_changed(value: float) -> void:
	if Engine.has_singleton("Settings"):
		Engine.get_singleton("Settings").set_master_volume(value)

func _on_music_volume_changed(value: float) -> void:
	if Engine.has_singleton("Settings"):
		Engine.get_singleton("Settings").set_music_volume(value)

func _on_sfx_volume_changed(value: float) -> void:
	if Engine.has_singleton("Settings"):
		Engine.get_singleton("Settings").set_sfx_volume(value)

func _on_voice_volume_changed(value: float) -> void:
	if Engine.has_singleton("Settings"):
		Engine.get_singleton("Settings").set_voice_volume(value)

func _on_battle_speed_changed(value: float) -> void:
	if Engine.has_singleton("Settings"):
		Engine.get_singleton("Settings").set_battle_speed(value)

func _on_text_speed_changed(value: float) -> void:
	if Engine.has_singleton("Settings"):
		Engine.get_singleton("Settings").set_text_speed(value)

func _on_encounter_rate_changed(value: float) -> void:
	if Engine.has_singleton("Settings"):
		Engine.get_singleton("Settings").set_encounter_rate(value)

func _on_show_damage_toggled(toggled_on: bool) -> void:
	if Engine.has_singleton("Settings"):
		Engine.get_singleton("Settings").set_show_damage_numbers(toggled_on)

func _on_battle_animations_toggled(toggled_on: bool) -> void:
	if Engine.has_singleton("Settings"):
		Engine.get_singleton("Settings").set_battle_animations(toggled_on)

func _on_skip_cutscenes_toggled(toggled_on: bool) -> void:
	if Engine.has_singleton("Settings"):
		Engine.get_singleton("Settings").set_skip_cutscenes(toggled_on)

func _on_save_pressed() -> void:
	if Engine.has_singleton("Settings"):
		Engine.get_singleton("Settings").save_settings()
